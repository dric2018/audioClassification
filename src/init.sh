...
python train.py --train_csv_path ../data/Giz-agri-keywords-data/train_test.csv --gpus 1 --test_batch_size 32 --train_batch_size 64 --kfold 3 --num_epochs 25 --img_size 224 --specs_images_path ../data/Giz-agri-keywords-data/datasets/images --save_models_to ../models --seed_value 2020 --lr 0.013182567385564073
